...
// Le chemin vers votre dossier d'images (à adapter selon la position de seed.js)
// Ajustez les chemins si le fichier seed.js n'est pas dans le dossier 'server/'
